...
void perform_kernel(cl_context& context, cl_command_queue& commandQueue, cl_program &program, cl_mem* memObjects, const char* kernelName) {
    // Create OpenCL kernel
    auto kernel = clCreateKernel(program, kernelName, NULL);
    if (kernel == NULL) {
